class Wizard < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/teddytennant/wizard/releases/download/v#{version}/wizard-aarch64-apple-darwin.tar.gz"
      sha256 "c9904f6040afa293cd05e5f5773710f2ec1e6f2bbc542718cd9fda2a90aa6b33"
    end
    on_intel do
      url "https://github.com/teddytennant/wizard/releases/download/v#{version}/wizard-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/teddytennant/wizard/releases/download/v#{version}/wizard-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "0266812cdc5b408c895167632a3f215288618d44d1787520a130047db7a1c803"
    end
    on_intel do
      url "https://github.com/teddytennant/wizard/releases/download/v#{version}/wizard-x86_64-unknown-linux-gnu.tar.gz"
